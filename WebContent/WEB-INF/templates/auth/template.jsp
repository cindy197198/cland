				...
				<div class="login-wrapper">
			        <div class="box">
			            <div class="content-wrap">
			            	<img width="100px" height="100px" class="img-circle" src="${contextPath}/resources/admin/images/icon-180x180.png">
			                <h6>Đăng nhập</h6>
			                <p style="font-style: italic;color: red;">${msg }</p>
			                <p style="font-style: italic;color: red;">${err }</p>
			                <form action="${contextPath }/cpanel/login" method="post">
